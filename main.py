from readdata import load_multiview_data_with_mask
import numpy as np
...
#----------------------------Data loading-------------------------#
mat_file = 'Yale_with_0.9_missing_rate.mat'
X_views, y, cluster_number, M_mask = load_multiview_data_with_mask(mat_file)
